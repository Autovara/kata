...
def screen_bundle_miner_contract(parsed_trees: dict[str, ast.AST]) -> list[ScreeningFinding]:
    ...
    # Helpers survived the screening centralization refactor, but their call sites
    # were dropped — restore them so no-op / canned agents cannot pass static screening.
