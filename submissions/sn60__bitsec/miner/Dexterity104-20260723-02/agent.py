...
FOCUS_COUNT = 12          # single-file deep reviews
PAIR_SPAN = 8             # files beyond the focus set covered two-per-call
RECHECK_COUNT = 2         # adversarial second reads of the very top files
WORKERS = 6
...
FOCUS_TOKENS = 14_000
PAIR_TOKENS = 12_000
RECHECK_TOKENS = 14_000

WALL_BUDGET = 1450.0
PER_CALL_TIMEOUT = 240.0
TAIL_RESERVE = 25.0
CALL_FLOOR = 30.0
CALL_RETRIES = 3
