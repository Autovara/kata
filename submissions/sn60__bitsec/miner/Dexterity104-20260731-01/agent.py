...
PAIR_FILE_CHARS = 6_000
PAIR_PROMPT_CHARS = 15_000
SURVEY_CHARS = 24_000
...
def build_jobs(records, by_base, endpoint, deadline):
    ...
    def pair_job(batch):
        return lambda: parse_findings(
            ask_model(endpoint, pair_prompt(batch), deadline, PAIR_TOKENS, "low"))
