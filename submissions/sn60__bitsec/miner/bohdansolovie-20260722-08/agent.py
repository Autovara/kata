"""SN60 Bitsec challenger — #179 PASS/TP + #180 zero-invalid hybrid.

#179: 1/7 PASS, 2 TP, 1 invalid → lost on precision.
#180: over-gated → 0 PASS, 0 TP, 0 invalid.
Win path vs king (~2.4 invalids): keep the PASS+TP, finish with 0 invalids,
then take the crown on the invalids tier (lead >2).
"""
...
EMIT_MAX = 12
DESC_MIN = 40
# #180 proved 0-invalid at ~700s; #179's PASS path needs the third call when slack exists.
WALL = 710.0
HTTP_TO = 180.0
RESERVE = 255.0
POST = 12.0
