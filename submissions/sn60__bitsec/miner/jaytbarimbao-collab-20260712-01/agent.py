...
The agent ranks the project's Solidity/Vyper sources by risk, then spends its
inference budget deliberately, inside the validator's hard per-problem limit
(3 successful model calls / 24k output tokens):
