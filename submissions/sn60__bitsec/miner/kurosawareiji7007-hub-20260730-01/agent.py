"""SN60 Bitsec miner — scout / focus / sweep recall pipeline.
...
SKIP = frozenset({
    ".git", ".github", "node_modules", "vendor", "vendors", "lib", "libs", "out",
    "artifacts", "cache", "coverage", "target", "dist", "build", "deps", "test",
    "tests", "mock", "mocks", "example", "examples", "script", "scripts",
